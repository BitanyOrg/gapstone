...
using MCInstGPU_AArch64 = MCInstGPU<6>;
...
#define AArch64MCRegisterClasses                                               \
  gapstone::AArch64Table::llvm::AArch64MCRegisterClasses
...
static DecodeStatus DecodeSimpleRegisterClass(MCInstGPU_AArch64 &Inst,
                                              unsigned RegNo, uint64_t Address,
                                              const MCDisassembler *Decoder);
static DecodeStatus
DecodeGPR64x8ClassRegisterClass(MCInstGPU_AArch64 &Inst, unsigned RegNo,
                                uint64_t Address,
                                const MCDisassembler *Decoder);
static DecodeStatus DecodeZPR2Mul2RegisterClass(MCInstGPU_AArch64 &Inst,
                                                unsigned RegNo,
                                                uint64_t Address,
                                                const void *Decoder);
static DecodeStatus DecodeZPR4Mul4RegisterClass(MCInstGPU_AArch64 &Inst,
                                                unsigned RegNo,
                                                uint64_t Address,
                                                const void *Decoder);
template <unsigned NumBitsForTile>
static DecodeStatus DecodeMatrixTile(MCInstGPU_AArch64 &Inst, unsigned RegNo,
                                     uint64_t Address,
                                     const MCDisassembler *Decoder);
static DecodeStatus
DecodeMatrixTileListRegisterClass(MCInstGPU_AArch64 &Inst, unsigned RegMask,
                                  uint64_t Address,
                                  const MCDisassembler *Decoder);
static DecodeStatus DecodePPR2Mul2RegisterClass(MCInstGPU_AArch64 &Inst,
                                                unsigned RegNo,
                                                uint64_t Address,
                                                const void *Decoder);

static DecodeStatus DecodeFixedPointScaleImm32(MCInstGPU_AArch64 &Inst,
                                               unsigned Imm, uint64_t Address,
                                               const MCDisassembler *Decoder);
static DecodeStatus DecodeFixedPointScaleImm64(MCInstGPU_AArch64 &Inst,
                                               unsigned Imm, uint64_t Address,
                                               const MCDisassembler *Decoder);
static DecodeStatus DecodePCRelLabel16(MCInstGPU_AArch64 &Inst, unsigned Imm,
                                       uint64_t Address,
                                       const MCDisassembler *Decoder);
static DecodeStatus DecodePCRelLabel19(MCInstGPU_AArch64 &Inst, unsigned Imm,
                                       uint64_t Address,
                                       const MCDisassembler *Decoder);
static DecodeStatus DecodeMemExtend(MCInstGPU_AArch64 &Inst, unsigned Imm,
                                    uint64_t Address,
                                    const MCDisassembler *Decoder);
static DecodeStatus DecodeMRSSystemRegister(MCInstGPU_AArch64 &Inst,
                                            unsigned Imm, uint64_t Address,
                                            const MCDisassembler *Decoder);
static DecodeStatus DecodeMSRSystemRegister(MCInstGPU_AArch64 &Inst,
                                            unsigned Imm, uint64_t Address,
                                            const MCDisassembler *Decoder);
static DecodeStatus
DecodeThreeAddrSRegInstruction(MCInstGPU_AArch64 &Inst, uint32_t insn,
                               uint64_t Address, const MCDisassembler *Decoder);
static DecodeStatus DecodeMoveImmInstruction(MCInstGPU_AArch64 &Inst,
                                             uint32_t insn, uint64_t Address,
                                             const MCDisassembler *Decoder);
static DecodeStatus
DecodeUnsignedLdStInstruction(MCInstGPU_AArch64 &Inst, uint32_t insn,
                              uint64_t Address, const MCDisassembler *Decoder);
static DecodeStatus DecodeSignedLdStInstruction(MCInstGPU_AArch64 &Inst,
                                                uint32_t insn, uint64_t Address,
                                                const MCDisassembler *Decoder);
static DecodeStatus
DecodeExclusiveLdStInstruction(MCInstGPU_AArch64 &Inst, uint32_t insn,
                               uint64_t Address, const MCDisassembler *Decoder);
static DecodeStatus DecodePairLdStInstruction(MCInstGPU_AArch64 &Inst,
                                              uint32_t insn, uint64_t Address,
                                              const MCDisassembler *Decoder);
static DecodeStatus DecodeAuthLoadInstruction(MCInstGPU_AArch64 &Inst,
                                              uint32_t insn, uint64_t Address,
                                              const MCDisassembler *Decoder);
static DecodeStatus DecodeAddSubERegInstruction(MCInstGPU_AArch64 &Inst,
                                                uint32_t insn, uint64_t Address,
                                                const MCDisassembler *Decoder);
static DecodeStatus DecodeLogicalImmInstruction(MCInstGPU_AArch64 &Inst,
                                                uint32_t insn, uint64_t Address,
                                                const MCDisassembler *Decoder);
static DecodeStatus DecodeModImmInstruction(MCInstGPU_AArch64 &Inst,
                                            uint32_t insn, uint64_t Address,
                                            const MCDisassembler *Decoder);
static DecodeStatus DecodeModImmTiedInstruction(MCInstGPU_AArch64 &Inst,
                                                uint32_t insn, uint64_t Address,
                                                const MCDisassembler *Decoder);
static DecodeStatus DecodeAdrInstruction(MCInstGPU_AArch64 &Inst, uint32_t insn,
                                         uint64_t Address,
                                         const MCDisassembler *Decoder);
static DecodeStatus DecodeAddSubImmShift(MCInstGPU_AArch64 &Inst, uint32_t insn,
                                         uint64_t Address,
                                         const MCDisassembler *Decoder);
static DecodeStatus DecodeUnconditionalBranch(MCInstGPU_AArch64 &Inst,
                                              uint32_t insn, uint64_t Address,
                                              const MCDisassembler *Decoder);
static DecodeStatus
DecodeSystemPStateImm0_15Instruction(MCInstGPU_AArch64 &Inst, uint32_t insn,
                                     uint64_t Address,
                                     const MCDisassembler *Decoder);
static DecodeStatus
DecodeSystemPStateImm0_1Instruction(MCInstGPU_AArch64 &Inst, uint32_t insn,
                                    uint64_t Address,
                                    const MCDisassembler *Decoder);
static DecodeStatus DecodeTestAndBranch(MCInstGPU_AArch64 &Inst, uint32_t insn,
                                        uint64_t Address,
                                        const MCDisassembler *Decoder);

static DecodeStatus DecodeFMOVLaneInstruction(MCInstGPU_AArch64 &Inst,
                                              unsigned Insn, uint64_t Address,
                                              const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftR64Imm(MCInstGPU_AArch64 &Inst, unsigned Imm,
                                         uint64_t Addr,
                                         const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftR64ImmNarrow(MCInstGPU_AArch64 &Inst,
                                               unsigned Imm, uint64_t Addr,
                                               const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftR32Imm(MCInstGPU_AArch64 &Inst, unsigned Imm,
                                         uint64_t Addr,
                                         const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftR32ImmNarrow(MCInstGPU_AArch64 &Inst,
                                               unsigned Imm, uint64_t Addr,
                                               const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftR16Imm(MCInstGPU_AArch64 &Inst, unsigned Imm,
                                         uint64_t Addr,
                                         const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftR16ImmNarrow(MCInstGPU_AArch64 &Inst,
                                               unsigned Imm, uint64_t Addr,
                                               const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftR8Imm(MCInstGPU_AArch64 &Inst, unsigned Imm,
                                        uint64_t Addr,
                                        const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftL64Imm(MCInstGPU_AArch64 &Inst, unsigned Imm,
                                         uint64_t Addr,
                                         const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftL32Imm(MCInstGPU_AArch64 &Inst, unsigned Imm,
                                         uint64_t Addr,
                                         const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftL16Imm(MCInstGPU_AArch64 &Inst, unsigned Imm,
                                         uint64_t Addr,
                                         const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftL8Imm(MCInstGPU_AArch64 &Inst, unsigned Imm,
                                        uint64_t Addr,
                                        const MCDisassembler *Decoder);
static DecodeStatus
DecodeWSeqPairsClassRegisterClass(MCInstGPU_AArch64 &Inst, unsigned RegNo,
                                  uint64_t Addr, const MCDisassembler *Decoder);
static DecodeStatus
DecodeXSeqPairsClassRegisterClass(MCInstGPU_AArch64 &Inst, unsigned RegNo,
                                  uint64_t Addr, const MCDisassembler *Decoder);
static DecodeStatus DecodeSyspXzrInstruction(MCInstGPU_AArch64 &Inst,
                                             uint32_t insn, uint64_t Addr,
                                             const MCDisassembler *Decoder);
static DecodeStatus
DecodeSVELogicalImmInstruction(MCInstGPU_AArch64 &Inst, uint32_t insn,
                               uint64_t Address, const MCDisassembler *Decoder);
template <int Bits>
static DecodeStatus DecodeSImm(MCInstGPU_AArch64 &Inst, uint64_t Imm,
                               uint64_t Address, const MCDisassembler *Decoder);
template <int ElementWidth>
static DecodeStatus DecodeImm8OptLsl(MCInstGPU_AArch64 &Inst, unsigned Imm,
                                     uint64_t Addr,
                                     const MCDisassembler *Decoder);
static DecodeStatus DecodeSVEIncDecImm(MCInstGPU_AArch64 &Inst, unsigned Imm,
                                       uint64_t Addr,
                                       const MCDisassembler *Decoder);
static DecodeStatus DecodeSVCROp(MCInstGPU_AArch64 &Inst, unsigned Imm,
                                 uint64_t Address,
                                 const MCDisassembler *Decoder);
static DecodeStatus DecodeCPYMemOpInstruction(MCInstGPU_AArch64 &Inst,
                                              uint32_t insn, uint64_t Addr,
                                              const MCDisassembler *Decoder);
static DecodeStatus DecodeSETMemOpInstruction(MCInstGPU_AArch64 &Inst,
                                              uint32_t insn, uint64_t Addr,
                                              const MCDisassembler *Decoder);
static DecodeStatus DecodePRFMRegInstruction(MCInstGPU_AArch64 &Inst,
                                             uint32_t insn, uint64_t Address,
                                             const MCDisassembler *Decoder);
...
#define MCInst MCInstGPU_AArch64
...
static DecodeStatus DecodeFMOVLaneInstruction(MCInstGPU_AArch64 &Inst,
                                              unsigned Insn, uint64_t Address,
                                              const MCDisassembler *Decoder) {
  // This decoder exists to add the dummy Lane operand to the MCInstGPU_AArch64,
...
static DecodeStatus DecodeVecShiftRImm(MCInstGPU_AArch64 &Inst, unsigned Imm,
                                       unsigned Add) {
  Inst.addOperand(MCOperand::createImm(Add - Imm));
  return Success;
}

static DecodeStatus DecodeVecShiftLImm(MCInstGPU_AArch64 &Inst, unsigned Imm,
                                       unsigned Add) {
...
static DecodeStatus DecodeGPRSeqPairsClassRegisterClass(
    MCInstGPU_AArch64 &Inst, unsigned RegClassID, unsigned RegNo, uint64_t Addr,
    const MCDisassembler *Decoder) {
