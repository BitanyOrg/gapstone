...
#include "Disassembler/AArch64Disassembler.h"
#include "Disassembler/AArch64ExternalSymbolizer.h"
#include "MCInstGPU.h"
#include "MCTargetDesc/AArch64AddressingModes.h"
#include "MCTargetDesc/AArch64MCTargetDesc.h"
#include "TargetInfo/AArch64TargetInfo.h"
#include "Utils/AArch64BaseInfo.cpp"
...
namespace gapstone {
namespace AArch64Table {
#define GET_REGINFO_MC_DESC
#include "AArch64GenRegisterInfo.inc"
}
} // namespace gapstone
#define AArch64MCRegisterClasses gapstone::AArch64Table::llvm::AArch64MCRegisterClasses
// #undef extern
...
static DecodeStatus DecodeSimpleRegisterClass(MCInstGPU<8> &Inst,
                                              unsigned RegNo, uint64_t Address,
                                              const MCDisassembler *Decoder);
static DecodeStatus
DecodeGPR64x8ClassRegisterClass(MCInstGPU<8> &Inst, unsigned RegNo,
                                uint64_t Address,
                                const MCDisassembler *Decoder);
static DecodeStatus DecodeZPR2Mul2RegisterClass(MCInstGPU<8> &Inst,
                                                unsigned RegNo,
                                                uint64_t Address,
                                                const void *Decoder);
static DecodeStatus DecodeZPR4Mul4RegisterClass(MCInstGPU<8> &Inst,
                                                unsigned RegNo,
                                                uint64_t Address,
                                                const void *Decoder);
template <unsigned NumBitsForTile>
static DecodeStatus DecodeMatrixTile(MCInstGPU<8> &Inst, unsigned RegNo,
                                     uint64_t Address,
                                     const MCDisassembler *Decoder);
static DecodeStatus
DecodeMatrixTileListRegisterClass(MCInstGPU<8> &Inst, unsigned RegMask,
                                  uint64_t Address,
                                  const MCDisassembler *Decoder);
static DecodeStatus DecodePPR2Mul2RegisterClass(MCInstGPU<8> &Inst,
                                                unsigned RegNo,
                                                uint64_t Address,
                                                const void *Decoder);

static DecodeStatus DecodeFixedPointScaleImm32(MCInstGPU<8> &Inst, unsigned Imm,
                                               uint64_t Address,
                                               const MCDisassembler *Decoder);
static DecodeStatus DecodeFixedPointScaleImm64(MCInstGPU<8> &Inst, unsigned Imm,
                                               uint64_t Address,
                                               const MCDisassembler *Decoder);
static DecodeStatus DecodePCRelLabel16(MCInstGPU<8> &Inst, unsigned Imm,
                                       uint64_t Address,
                                       const MCDisassembler *Decoder);
static DecodeStatus DecodePCRelLabel19(MCInstGPU<8> &Inst, unsigned Imm,
                                       uint64_t Address,
                                       const MCDisassembler *Decoder);
static DecodeStatus DecodeMemExtend(MCInstGPU<8> &Inst, unsigned Imm,
                                    uint64_t Address,
                                    const MCDisassembler *Decoder);
static DecodeStatus DecodeMRSSystemRegister(MCInstGPU<8> &Inst, unsigned Imm,
                                            uint64_t Address,
                                            const MCDisassembler *Decoder);
static DecodeStatus DecodeMSRSystemRegister(MCInstGPU<8> &Inst, unsigned Imm,
                                            uint64_t Address,
                                            const MCDisassembler *Decoder);
static DecodeStatus
DecodeThreeAddrSRegInstruction(MCInstGPU<8> &Inst, uint32_t insn,
                               uint64_t Address, const MCDisassembler *Decoder);
static DecodeStatus DecodeMoveImmInstruction(MCInstGPU<8> &Inst, uint32_t insn,
                                             uint64_t Address,
                                             const MCDisassembler *Decoder);
static DecodeStatus
DecodeUnsignedLdStInstruction(MCInstGPU<8> &Inst, uint32_t insn,
                              uint64_t Address, const MCDisassembler *Decoder);
static DecodeStatus DecodeSignedLdStInstruction(MCInstGPU<8> &Inst,
                                                uint32_t insn, uint64_t Address,
                                                const MCDisassembler *Decoder);
static DecodeStatus
DecodeExclusiveLdStInstruction(MCInstGPU<8> &Inst, uint32_t insn,
                               uint64_t Address, const MCDisassembler *Decoder);
static DecodeStatus DecodePairLdStInstruction(MCInstGPU<8> &Inst, uint32_t insn,
                                              uint64_t Address,
                                              const MCDisassembler *Decoder);
static DecodeStatus DecodeAuthLoadInstruction(MCInstGPU<8> &Inst, uint32_t insn,
                                              uint64_t Address,
                                              const MCDisassembler *Decoder);
static DecodeStatus DecodeAddSubERegInstruction(MCInstGPU<8> &Inst,
                                                uint32_t insn, uint64_t Address,
                                                const MCDisassembler *Decoder);
static DecodeStatus DecodeLogicalImmInstruction(MCInstGPU<8> &Inst,
                                                uint32_t insn, uint64_t Address,
                                                const MCDisassembler *Decoder);
static DecodeStatus DecodeModImmInstruction(MCInstGPU<8> &Inst, uint32_t insn,
                                            uint64_t Address,
                                            const MCDisassembler *Decoder);
static DecodeStatus DecodeModImmTiedInstruction(MCInstGPU<8> &Inst,
                                                uint32_t insn, uint64_t Address,
                                                const MCDisassembler *Decoder);
static DecodeStatus DecodeAdrInstruction(MCInstGPU<8> &Inst, uint32_t insn,
                                         uint64_t Address,
                                         const MCDisassembler *Decoder);
static DecodeStatus DecodeAddSubImmShift(MCInstGPU<8> &Inst, uint32_t insn,
                                         uint64_t Address,
                                         const MCDisassembler *Decoder);
static DecodeStatus DecodeUnconditionalBranch(MCInstGPU<8> &Inst, uint32_t insn,
                                              uint64_t Address,
                                              const MCDisassembler *Decoder);
static DecodeStatus
DecodeSystemPStateImm0_15Instruction(MCInstGPU<8> &Inst, uint32_t insn,
                                     uint64_t Address,
                                     const MCDisassembler *Decoder);
static DecodeStatus
DecodeSystemPStateImm0_1Instruction(MCInstGPU<8> &Inst, uint32_t insn,
                                    uint64_t Address,
                                    const MCDisassembler *Decoder);
static DecodeStatus DecodeTestAndBranch(MCInstGPU<8> &Inst, uint32_t insn,
                                        uint64_t Address,
                                        const MCDisassembler *Decoder);

static DecodeStatus DecodeFMOVLaneInstruction(MCInstGPU<8> &Inst, unsigned Insn,
                                              uint64_t Address,
                                              const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftR64Imm(MCInstGPU<8> &Inst, unsigned Imm,
                                         uint64_t Addr,
                                         const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftR64ImmNarrow(MCInstGPU<8> &Inst, unsigned Imm,
                                               uint64_t Addr,
                                               const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftR32Imm(MCInstGPU<8> &Inst, unsigned Imm,
                                         uint64_t Addr,
                                         const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftR32ImmNarrow(MCInstGPU<8> &Inst, unsigned Imm,
                                               uint64_t Addr,
                                               const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftR16Imm(MCInstGPU<8> &Inst, unsigned Imm,
                                         uint64_t Addr,
                                         const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftR16ImmNarrow(MCInstGPU<8> &Inst, unsigned Imm,
                                               uint64_t Addr,
                                               const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftR8Imm(MCInstGPU<8> &Inst, unsigned Imm,
                                        uint64_t Addr,
                                        const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftL64Imm(MCInstGPU<8> &Inst, unsigned Imm,
                                         uint64_t Addr,
                                         const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftL32Imm(MCInstGPU<8> &Inst, unsigned Imm,
                                         uint64_t Addr,
                                         const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftL16Imm(MCInstGPU<8> &Inst, unsigned Imm,
                                         uint64_t Addr,
                                         const MCDisassembler *Decoder);
static DecodeStatus DecodeVecShiftL8Imm(MCInstGPU<8> &Inst, unsigned Imm,
                                        uint64_t Addr,
                                        const MCDisassembler *Decoder);
static DecodeStatus
DecodeWSeqPairsClassRegisterClass(MCInstGPU<8> &Inst, unsigned RegNo,
                                  uint64_t Addr, const MCDisassembler *Decoder);
static DecodeStatus
DecodeXSeqPairsClassRegisterClass(MCInstGPU<8> &Inst, unsigned RegNo,
                                  uint64_t Addr, const MCDisassembler *Decoder);
static DecodeStatus DecodeSyspXzrInstruction(MCInstGPU<8> &Inst, uint32_t insn,
                                             uint64_t Addr,
                                             const MCDisassembler *Decoder);
static DecodeStatus
DecodeSVELogicalImmInstruction(MCInstGPU<8> &Inst, uint32_t insn,
                               uint64_t Address, const MCDisassembler *Decoder);
template <int Bits>
static DecodeStatus DecodeSImm(MCInstGPU<8> &Inst, uint64_t Imm,
                               uint64_t Address, const MCDisassembler *Decoder);
template <int ElementWidth>
static DecodeStatus DecodeImm8OptLsl(MCInstGPU<8> &Inst, unsigned Imm,
                                     uint64_t Addr,
                                     const MCDisassembler *Decoder);
static DecodeStatus DecodeSVEIncDecImm(MCInstGPU<8> &Inst, unsigned Imm,
                                       uint64_t Addr,
                                       const MCDisassembler *Decoder);
static DecodeStatus DecodeSVCROp(MCInstGPU<8> &Inst, unsigned Imm,
                                 uint64_t Address,
                                 const MCDisassembler *Decoder);
static DecodeStatus DecodeCPYMemOpInstruction(MCInstGPU<8> &Inst, uint32_t insn,
                                              uint64_t Addr,
                                              const MCDisassembler *Decoder);
static DecodeStatus DecodeSETMemOpInstruction(MCInstGPU<8> &Inst, uint32_t insn,
                                              uint64_t Addr,
                                              const MCDisassembler *Decoder);
static DecodeStatus DecodePRFMRegInstruction(MCInstGPU<8> &Inst, uint32_t insn,
                                             uint64_t Address,
                                             const MCDisassembler *Decoder);
...
static DecodeStatus DecodePCRelLabel19(MCInstGPU<8> &Inst, unsigned Imm,
  ...
  //         Inst, ImmVal * 4, Addr, Inst.getOpcode() != AArch64::LDRXl, 0, 0,
  //         4))
  Inst.addOperand(MCOperand::createImm(ImmVal));
  return Success;
}
...
static DecodeStatus DecodeFMOVLaneInstruction(MCInstGPU<8> &Inst, unsigned Insn,
                                              uint64_t Address,
                                              const MCDisassembler *Decoder) {
  // This decoder exists to add the dummy Lane operand to the MCInstGPU<8>,
  // which must be 1 in assembly but has no other real manifestation.
...
static DecodeStatus DecodeVecShiftRImm(MCInstGPU<8> &Inst, unsigned Imm,
                                       unsigned Add) {
  Inst.addOperand(MCOperand::createImm(Add - Imm));
  return Success;
}

static DecodeStatus DecodeVecShiftLImm(MCInstGPU<8> &Inst, unsigned Imm,
                                       unsigned Add) {
...
static DecodeStatus
DecodeThreeAddrSRegInstruction(MCInstGPU<8> &Inst, uint32_t insn, uint64_t Addr,
                               const MCDisassembler *Decoder) {
  unsigned Rd = fieldFromInstruction(insn, 0, 5);
  unsigned Rn = fieldFromInstruction(insn, 5, 5);
...
static DecodeStatus
DecodeUnsignedLdStInstruction(MCInstGPU<8> &Inst, uint32_t insn, uint64_t Addr,
                              const MCDisassembler *Decoder) {
...
static DecodeStatus
DecodeExclusiveLdStInstruction(MCInstGPU<8> &Inst, uint32_t insn, uint64_t Addr,
                               const MCDisassembler *Decoder) {
  unsigned Rt = fieldFromInstruction(insn, 0, 5);
  unsigned Rn = fieldFromInstruction(insn, 5, 5);
...
static DecodeStatus
DecodeGPRSeqPairsClassRegisterClass(MCInstGPU<8> &Inst, unsigned RegClassID,
...
static DecodeStatus
DecodeSVELogicalImmInstruction(MCInstGPU<8> &Inst, uint32_t insn, uint64_t Addr,
                               const MCDisassembler *Decoder) {
